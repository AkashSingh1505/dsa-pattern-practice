...
function dsaWireSketchEditorStudio(editorRoot, onChange, sketchOpts) {
    ...
    if (!document.head.querySelector("link[data-dsa-sketch-studio-css]")) {
        ...
        lk.rel = "stylesheet";
        lk.href = "./dsa-sketch-studio.css?v=8";
...
setInterval(()=>{
  if(S.lastPenT&&performance.now()-S.lastPenT>5000){
    ...
    if (miniFsBtn) miniFsBtn.addEventListener('click', () => enterFakeFullscreen());
    const minMinBtn = $('dsaSkMinMinBtn');
    if (minMinBtn) minMinBtn.addEventListener('click', () => leaveFakeFullscreen());
